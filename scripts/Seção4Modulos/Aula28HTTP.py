...
# https://www.youtube.com/watch?v=Qd8JT0bnJGs  -> estudar depois requests
...
# python -m http.server 3333 --directory "C:\Users\kaver\OneDrive\Área de Trabalho\Python Scripts\scripts\Seção4Modulos\Aula29HTTPsite"

# o comando acima serve para mandar um html para um localhost, basta mudar a porta e o diretorio se precisar
...
url = "http://localhost:3333/"  # endereço
response = requests.get(url)  # metodo GET, passando o endereço

print(response.status_code) # mostra o codigo de status, se estiver 200 é pq ta tudo certo, o url foi achado
print(response.headers) # mostra umas informações ai
print(response.text) # puxa o codigo html do site