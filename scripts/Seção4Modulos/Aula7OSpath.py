...
caminho = os.path.join('Desktop', 'curso', 'arquivo.txt') # faz com que o caminho do arquivo se ajuste de acordo
print(caminho) # mostra o arquivo                                            # com o sistema operacional(\/)
diretorio, arquivo = os.path.split(caminho)# divide o caminho do arquivo
