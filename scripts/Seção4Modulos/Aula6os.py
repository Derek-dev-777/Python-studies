...
import os
# meio q ele sempre ira executar oq eu colocar nos () no sistema.
os.system('clear') # faz com que sempre q eu execute um programa, no proximo ele ira limpar meu terminal
