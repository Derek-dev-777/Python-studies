...
print(calendar.calendar(2022)) #mostra o calendario completo do ano passado
print(calendar.month(2022, 12)) # mostra o calendario do ano passado, e do mes passado
